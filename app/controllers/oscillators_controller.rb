class OscillatorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @oscillator.save
        format.html { redirect_to oscillator_url(@oscillator), notice: "Oscillator was successfully created." }
  ...
  def update
    respond_to do |format|
      if @oscillator.update(oscillator_params)
        format.html { redirect_to oscillator_url(@oscillator), notice: "Oscillator was successfully updated." }
